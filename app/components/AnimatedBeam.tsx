...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex h-12 w-12 items-center justify-center rounded-full text-rose-600 text-lg border-2 bg-white p-16 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className,
      )}
    >
      {children}
...
export function AnimatedBeamDemo() {
  ...
  return (
    <div
      className="relative flex w-full m-auto max-w-[900px] items-center justify-center overflow-hidden   p-10 "
      ref={containerRef}
    >
